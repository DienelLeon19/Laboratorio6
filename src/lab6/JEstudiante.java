...
public class JEstudiante extends javax.swing.JFrame {
    ...
    List<Estudiantes> DEstu = new ArrayList<>();
      
    public JEstudiante() 
    {initComponents();}
    
    public JEstudiante(GestorCursos padre) 
    {   
        initComponents();
        this.padre = padre;
    }
    public JEstudiante(GestorCursos padre,Curso NuevoCurs, int index) 
    {   initComponents();
        this.padre = padre;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Diseños/Estudiantes de _.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 200, 40));

        CursoName.setText("curso");
        jPanel1.add(CursoName, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 40, -1, -1));
    ...
    private void btn_BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_BuscarActionPerformed
        ...
        String name = txt_Datos.getText().trim();
            if (name.isEmpty()){
                ...
                Estu.clear();
                for (Estudiantes estudiante : NuevoCurs.getEstudiante()){
                    if (estudiante != null) {
                        if (estudiante.getNombre().equals(name)) {
                            String fullName="Nombre: " + estudiante.getNombre()
                                    + " Codigo: " + estudiante.getCodigo();
                            Estu.addElement(fullName);
                        }
                    }
                }
     ...
     public void TraerEstudiante(){
        ...
        Estudiantes[] estudiantes = NuevoCurs.getEstudiante();
    ...
    private void btn_EditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EditarActionPerformed
        int inde = lst_Estudiantes.getSelectedIndex();
        Estudiantes[] estudiantes = NuevoCurs.getEstudiante();
        Estudiantes estudiante = estudiantes[inde];
        MostrarN(NuevoCurs, estudiante, inde);
    
    }//GEN-LAST:event_btn_EditarActionPerformed
  
    public void agregarNuevo(Estudiantes student) 
    {
        DEstu.add(student);
        Estu.addElement(student.Texto());
        lst_Estudiantes.setModel(Estu);
    }

    public void agregarEstudiante(Estudiantes NuevoEstudiante)
    {   NuevoCurs.agregarEstudiante(NuevoEstudiante);}

  
    
     private void MostrarN(Curso NuevoCurs, Estudiantes NEstudiante, int index)
     { 
        NewEstudiante editEstudiante = new NewEstudiante(this, 
        NEstudiante, index, NuevoCurs);

        editEstudiante.setLocationRelativeTo(null);
        editEstudiante.setVisible(true);
        editEstudiante.apagarventana();
        this.setVisible(false);
    }
